...
class StaffSignaturePad extends StatefulWidget {
  final Function(String) onSave;
  final String? existingSignature;
  const StaffSignaturePad({
    Key? key,
  ...
  @override
  _StaffSignaturePadState createState() => _StaffSignaturePadState();
}

class _StaffSignaturePadState extends State<StaffSignaturePad> {
