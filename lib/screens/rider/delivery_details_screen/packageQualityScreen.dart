...
class PackageQualityCheckScreen extends StatefulWidget {
  final String deliveryId;

  const PackageQualityCheckScreen({super.key, required this.deliveryId});

  @override
  State<PackageQualityCheckScreen> createState() =>
      _PackageQualityCheckScreenState();
}

class _PackageQualityCheckScreenState extends State<PackageQualityCheckScreen>
